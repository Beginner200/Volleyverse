...
function createScene(){
  ...
  try{
    ...
    const camMode=localStorage.getItem('volleyverseCamera')||'broadcast';if(camMode==='player')state.camera.position.set(0,8,15);else if(camMode==='sideline')state.camera.position.set(13,6,7);else if(camMode==='top')state.camera.position.set(0,25,.1);else state.camera.position.set(0,13.2,23.5);state.camera.lookAt(0,0.7,0);
