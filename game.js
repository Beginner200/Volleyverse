...
function applyGameplayCamera(mode){
  ...
  if(m==='player'&&target){const followDistance=6.0;const followHeight=3.8;state.camera.position.set(wx,followHeight,wz+followDistance);state.camera.lookAt(wx,1.15,wz)}
