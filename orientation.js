(()=>{
  const loadTheme=()=>{if(document.getElementById('volleyballTheme'))return;const css=document.createElement('link');css.id='volleyballTheme';css.rel='stylesheet';css.href='volleyball-theme.css';document.head.appendChild(css)};
